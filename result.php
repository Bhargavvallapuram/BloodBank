...
?>
 ...
 <a href="doner_pic<?php echo $data[8] ?>"data-lightbox="image-1"> <img src="doner_pic/<?php echo $data[8] ?>" height="100px" width="100px" style="margin:auto; padding-left:70px; padding-right:50px; float:left" /></a></td>
           ...
           <tr><td colspan="2">&nbsp;</td></tr>
                <tr><td><span class="title" style="margin-left: 25px;">Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td><td><?php echo $data[1]; ?></td><td align="left" width="50%"></td></tr>
                 <tr><td><span class="title" style="margin-left: 25px;">Gender</span></td><td><?php echo $data[2]; ?></td></tr>
                  <tr><td style="width:24px"><span class="title" style="margin-left: 25px;">Mobile No:</span></td><td><?php echo $data[4]; ?></td></tr>
                  <tr><td><span class="title" style="margin-left: 25px;">Email</span></td><td><?php echo $data[6]; ?></td></tr>
                   <tr><td><span class="title" style="margin-left: 25px;">Blood Group</span></td><td><?php echo $data[10]; ?></td></tr>
...
<div class="footer">
	<div class="f_nav">
		...
		<div class="copy">
        <p class="title">© All Rights Reserved by <spam style="color: green">SRGEC</spam> </p>
		</div>
	<div class="clear"></div>
</div>
</div>
